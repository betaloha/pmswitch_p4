...
// Korakit ///////////
// For this implementation, we use sequence number to index the PM instead of real hashed address to avoid implementing log state checking on the slow softcore.
...
control PMSwitchRequestProcessing(inout headers hdr,
    ...
    action AccessMemory() {
        ...
        ctrl.hashedAddress  = hdr.pmswitchhds.seq_no+0x80000000;
